...
```text
杨多多/
  12-ZB-杨多多-祷告男-佳佳-不要划走这个视频，因为这条信息是给你的。-46211-FF-2026-7-9.mp4
```
...
- 服务账号 JSON，例如 `青苹果下载器 1.json`
- OAuth 桌面应用 JSON，例如 `credentials.json`

如果使用服务账号，把 `青苹果下载器 1.json` 放到本文件夹即可，程序会优先自动选择它。
