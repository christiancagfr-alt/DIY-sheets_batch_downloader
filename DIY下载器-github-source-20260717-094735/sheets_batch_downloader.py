...
class App(tk.Tk):
    def __init__(self):
        ...
        default_service_account = os.path.join(base_dir, "青苹果下载器 1.json")
    ...
    def _build_ui(self):
        ...
        ttk.Label(mode, text="person=杨多多；prefix=12-ZB-杨多多；full=整行 A 列", style="Muted.TLabel").pack(side=tk.LEFT, padx=10)
